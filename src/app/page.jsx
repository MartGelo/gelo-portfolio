            ...
            <div className="container grid grid-cols-1 lg:grid-cols-[1fr,300px] gap-12 px-4 lg:px-6">
                <div className="text-white mb-10">
                    <div>
                        ...
                        <div className="text-xl lg:text-1xl text-justify leading-relaxed mt-2">
                            I'm currently taking Bachelor of Science in
                            Information Technology in Aurora State
                        </div>
                        <p className="text-xl lg:text-1xl text-justify leading-relaxed mb-4">
                            College of Technology (ASCOT), a junior software
                            engineer from Aurora{' '}
                        </p>
                    </div>

                    <div className="flex flex-wrap lg:justify-left">
                        <a
                        ...
                        <a
                            ...
                            className="mr-6 mb-2 lg:mb-0  py-2 text-white dark:text-neutral-200  hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100"
                            target="_blank">
                            <svg
